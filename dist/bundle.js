...
const io = __webpack_require__(49);
let socket = io();
...
class App extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "game" },
            React.createElement(header_1.default, { post: (msg) => { this.messagePosted(msg); }, coordinates: this.state.coordinates }),
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(4);
const message_1 = __webpack_require__(24);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(4);
const logo = __webpack_require__(57);
class Header extends React.Component {
    constructor(props) {
        super(props);
        this.prevMessageIndex = -1;
        this.previousMessages = new Array();
        this.state = {
            input: '',
        };
    }
    ...
    setToPreviousMessage(e, incrementer) {
        var min = 0;
    ...
    render() {
        return (React.createElement("div", { className: "game-header" },
            ...
            React.createElement("input", { autoFocus: true, className: "game-input", type: "text", onBlur: (e) => this.resetFocus(e), onKeyDown: (e) => this.keyPress(e), onChange: (e) => this.updateState(e), value: this.state.input }),
...
const App_1 = __webpack_require__(21);
